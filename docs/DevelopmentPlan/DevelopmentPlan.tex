...
\begin{tabular}{|>{\raggedright}p{3cm}|>{\raggedright}p{4.25cm}|>{\raggedright\arraybackslash}p{6cm}|}
  ...
  \hline
  Code Formatting & Linter(s) &  Specific tools are ndetermined at this stage as it is language dependant. 
  To be used with CI workflows to format code.\\
  \hline
  Testing & MATLAB unittest/automation, CMake, Unity, etc.  & Undetermined, likely a unit testing framework
