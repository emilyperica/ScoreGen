...
\begin{longtable}{|l|*{5}{c|}*{5}{c|}}
 ...
 % Functional Requirements - Audio Input Handling
FR-AI1 & x &  &  &  &  &  &  &  &  &  \\ \hline
FR-AI2 & x &  &  & x &  &  &  &  &  &  \\ \hline
FR-AI3 & x &  &  & x &  &  &  &  &  &  \\ \hline
FR-AI4 &  &  &  & x &  &  &  &  &  &  \\ \hline
...
PR-PA2  & x & x &  & x &  &  &  &  &  &  \\ \hline
PR-RFT1 & x &  &  & x &  &  &  &  &  &  \\ \hline
PR-RFT2 & x & x & x & x &  &  &  &  &  &  \\ \hline
PR-RFT3 & x & x & x & x &  &  &  &  &  &  \\ \hline
PR-RFT4 & x &  &  & x &  &  &  &  &  &  \\ \hline
PR-RFT5 & x & x & x &  &  &  &  &  &  &  \\ \hline
PR-RFT6 & x &  &  & x &  &  &  &  &  &  \\ \hline
PR-RFT7 & x & x & x & x &  &  &  &  &  &  \\ \hline
PR-C1   & x & x & x &  &  &  &  &  &  &  \\ \hline
PR-C2   & x & x & x & x &  &  &  &  &  &  \\ \hline
PR-SE1  & x & x & x & x & x &  &  &  &  &  \\ \hline
PR-SE2  &  &  &  &  & x &  &  &  &  &  \\ \hline
PR-SE3  & x & x &  &  &  &  &  &  &  &  \\ \hline
PR-L1   &  &  &  &  & x &  &  &  &  &  \\ \hline
