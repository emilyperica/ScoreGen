...
2025-03-18 & 1.0 & Addressing peer review issues 
  \href{https://github.com/emilyperica/ScoreGen/issues/289}{\#289}, 
  \href{https://github.com/emilyperica/ScoreGen/issues/290}{\#290}, and 
  \href{https://github.com/emilyperica/ScoreGen/issues/292}{\#292}. \\
2025-03-24 & 1.1 & Addressed \href{https://github.com/emilyperica/ScoreGen/issues/293}{Issue 293}. \\
\bottomrule
\end{tabularx}
...
type are grouped similarly, resulting in five subcategories.
  ...
  \begin{enumerate}
    \item \textbf{Test for Correct Audio File Formats} \\
      ...
      \textbf{Input:} Audio file (i.e., \texttt{.WAV}) \\
  ...
  (i.e., \texttt{.WAV}). \\
  \textbf{Actual Output:} The application captures the correct audio and saves it as a \texttt{.WAV} file. \\
...
\begin{enumerate}
    ...
    \item \textbf{Test for UH-A1 Web Content Accessibility Guidelines (WCAG) Compliance} \\
      ...
      \textbf{Results:} Fail. The app the app does not yet meet every one of the exhaustive standards from \citep*{WCAG21}. Note that we are not 
      including the full list of what is compliant and not compliant for brevity.\\
\end{enumerate}
...
\begin{enumerate}
    ...
    \item \textbf{Test for OE-IA2 Audio File Import and Export} \\
      ...
      \textbf{Input/Condition:} Use sample audio files in \texttt{.WAV} (PCM) format for import and export. \\
      \textbf{Output/Result:} The app should successfully import and export audio files in \texttt{.WAV} format. \\
      \textbf{How Test Was Performed:}
      \begin{enumerate}
          \item Import \texttt{.WAV} files into the app and verify playback or analysis accuracy.
          \item Export audio file in \texttt{.WAV} format, ensuring it is playable in standard audio players.
          \item Confirm that imported and exported files retain their quality and format specifications.
      \end{enumerate}
      \textbf{Success Criterion:} The test is passed if the app successfully imports and exports audio files in \texttt{.WAV} format.\\
      \textbf{Results:} Pass. \texttt{.WAV} files are succefully imported and exported. \\
    ...
    \item \textbf{Test for OE-IA3 Music Notation Software Integration} \\
      ...
      \begin{enumerate}
          ...
          \item Test the exported files in another music notation software to ensure compatibility and accuracy.
      \end{enumerate}
      \textbf{Success Criterion:} The test is passed if the exported files are compatible with popular music notation software.\\
      \textbf{Results:} Pass. The exported MusicXML files are compatible with \href{https://www.soundslice.com/}{Soundslice}, a popular music notation web app.\\
...
\begin{enumerate}
    ...
    \item \textbf{Test for CR-SCR1 Technological Standards} \\
      ...
      \begin{enumerate}
          ...
          \item Open the exported file in compatible notation software (i.e., Soundslice) to confirm it is error-free and follows the 
          MusicXML standard.
...
\begin{enumerate}
  ...
  \item \textbf{\texttt{.WAV} File Read/Write Cycle:} The mismatch between data vectors of the original and output files, and consequent 
