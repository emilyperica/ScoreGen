...
\begin{description}[style=nextline]
    ...
    \item[Preconditions:]
    \begin{itemize}
        \item The user has selected an instrument (e.g., piano, guitar).
        \item The user has a working microphone connected to the desktop app.
    \end{itemize}

    \item[Main Success Scenario:]
    \begin{enumerate}
        \item The user begins playing the instrument.
        \item The system listens to the instrument through the microphone.
...
\begin{description}[style=nextline]
    ...
    \item[Main Success Scenario:]
    \begin{enumerate}
        \item The user selects a file format (PDF, MIDI, MusicXML).
...
\begin{description}[style=nextline]
    ...
    \item[Preconditions:]
    \begin{itemize}
        \item The user is actively recording their instrument.
    \end{itemize}
    ...
    \item[Exceptions:]
    \begin{itemize}
        \item The system suggests that the user retry playing the note or manually insert it later, either within the app or using a third-party tool depending on available features.
    \end{itemize}
\end{description}
