...
\textbf{Requirement:} The interface between the user and the sheet music generator app shall within a reasonable time when processing input or selecting menu options.\\
...
\textbf{Requirement:} A critical requirement of this app is the precision at which it identifies notes. As a result, this app shall correctly detect musical pitch from instruments' input to ensure that all notes are transcribed correctly.\\
