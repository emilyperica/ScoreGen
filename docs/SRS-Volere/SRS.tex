...
30/01/2025 & 0.1 & Added OTS software considerations\\
\bottomrule
\end{tabularx}
...
Note that there are off-the-shelf software options for generating sheet music, however for the purpose of this capstone project, the team will not be using any of these options. 
The reason for this is to learn how to do these tasks ourselves wthout relying on external libraries for everything.
...
\textbf{Rationale}: MusicXML is the industry-standard format for sheet music interchange between different music notation software, ensuring compatibility with tools like Sibelius, Finale, MuseScore, and other DAWs. Its widespread adoption makes it the best choice for interoperability and limits the scope of this project's development.\\
...
\subsubsection*{MIDI Format}
\textbf{Description}: The app shall support MIDI file formats for audio playback\\
\textbf{Rationale}: MIDI format is popular for music playback and editing, and its support will enhance the app’s usability and are easily interfaced with libraries such as \href{https://www.midijs.net/}{MIDIjs}.\\
\textbf{Fit Criterion}: The app must successfully play audio for sheet music from MIDI files.
