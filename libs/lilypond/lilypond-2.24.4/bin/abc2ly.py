...
# is not next to bin/.
sys.path.insert (0, os.path.join ('/home/lily/lilypond-2.24.4/release/binaries/mingw/lilypond/install/share/lilypond/2.24.4', 'python'))
...
gettext.install('lilypond', '/home/lily/lilypond-2.24.4/release/binaries/mingw/lilypond/install/share/locale')
...
''') % 'http://abcnotation.com/abc2mtex/abc.txt',
    ...
    p.version = "abc2ly (LilyPond) 2.24.4"
